...
public class LaporanNilaiPanel extends JPanel {
    ...
    private void loadDataNilai() {
        ...
        for (Object[] nilai : Database.getAllNilai()) {
            ...
            if (siswa != null) kelas = siswa[5];
            tableModel.addRow(new Object[]{no++, nilai[0], nilai[1], kelas, nilai[2], nilai[3], nilai[4], nilai[5]});
        }
    }
    ...
    private void filterData() {
        ...
        for (Object[] nilai : Database.getAllNilai()) {
            ...
            if (siswa != null && siswa[5].equals(selectedKelas)) {
                tableModel.addRow(new Object[]{no++, nilai[0], nilai[1], siswa[5], nilai[2], nilai[3], nilai[4], nilai[5]});
            }
        }
    ...
    private void cetakPDF() {
        ...
        try {
            ...
            fileChooser.setSelectedFile(new java.io.File("Laporan_Nilai_SMA_PGRI_4.pdf"));
